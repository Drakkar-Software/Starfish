...
→ [TypeScript client guide](/getting-started/intro)

```bash
pip install starfish-sdk
```

→ [Python server guide](/python/server/storage)

## Sections

| Section | Description |
|---------|-------------|
| [TypeScript Client](/getting-started/intro) | 31-page guide: sync, encryption, auth, offline, patterns |
