...
> **Prerequisites:** [SyncManager](/client-core/sync-manager), [Zustand](/state-offline/state-zustand) or [Legend State](/state-offline/state-legend)
...
See [Conflict Resolution — Soft-delete-aware merge](/client-core/conflict-resolution#soft-delete-aware-merge) for the merge implementation.
...
> For a comprehensive guide on document partitioning, URL design, and dynamic documents, see [Multi-Document Architecture](/data-modeling/multi-document-architecture).
...
- [Schema Versioning](/data-modeling/schema-versioning) — evolving the sync document format
- [Conflict Resolution](/client-core/conflict-resolution) — custom merge strategies for complex documents
- [Testing Strategies](/integration-operations/testing) — testing the integration layer
- [Multi-Document Architecture](/data-modeling/multi-document-architecture) — partitioning and URL design
