...
> **Prerequisites:** [SyncManager](/client-core/sync-manager), [Zustand Binding](/state-offline/state-zustand), [Conflict Resolution](/client-core/conflict-resolution)
...
See [Conflict Resolution](/client-core/conflict-resolution) for the full set of strategies to test.
...
- [Conflict Resolution](/client-core/conflict-resolution) — resolver implementations to test
- [Schema Versioning](/data-modeling/schema-versioning) — testing migration chains
- [Error Classification & Retry](/client-core/error-retry) — testing error handling
