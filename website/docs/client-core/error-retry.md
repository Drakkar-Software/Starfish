...
> **Prerequisites:** [StarfishClient](/client-core/starfish-client), [Offline & Connectivity](/state-offline/offline-connectivity)
...
Extend the `deriveSyncStatus` function from [Offline & Connectivity](/state-offline/offline-connectivity) to surface error categories:
...
- [StarfishClient](/client-core/starfish-client) — custom fetch injection point
- [Offline & Connectivity](/state-offline/offline-connectivity) — sync status indicators
- [Logging & Observability](/integration-operations/logging-observability) — logging errors and retries
