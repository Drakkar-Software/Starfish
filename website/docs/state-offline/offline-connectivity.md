...
> **Prerequisites:** [Zustand Binding](/state-offline/state-zustand) or [Legend State Binding](/state-offline/state-legend)
...
- [Integration Patterns](/integration-operations/integration-patterns) — debounced push, restore-loop prevention, optimistic UI
- [Zustand Binding](/state-offline/state-zustand) — persistence configuration
- [Error Classification & Retry](/client-core/error-retry) — retry strategies and error-aware sync status
