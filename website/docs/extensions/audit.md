...
- [Queuing](/extensions/queuing) — queue events are a separate stream and are not duplicated in the audit log
- [Logging](/integration-operations/logging-observability) — structured sync logging on the client side
