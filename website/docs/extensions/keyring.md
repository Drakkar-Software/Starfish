...
- [Encryption model](/encryption-identity/encryption)
- [Multi-recipient delegated encryption](/encryption-identity/multi-recipient-delegated) — keyring schema, epoch rotation, recipient management, the owner-only `_members` directory.
