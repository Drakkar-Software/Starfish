...
> **Prerequisites:** [Group Access Control](/server/group-access), [Collection Patterns](/data-modeling/collection-patterns)
...
- [Role Enrichers](/data-modeling/collection-patterns) — group-based access control
- [Collection Patterns](/data-modeling/collection-patterns) — general RBAC patterns
- [Audit Logging](/extensions/audit) — log which identity accessed which collection and when
