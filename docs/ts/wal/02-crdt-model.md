...
[`tests/test-vectors/wal-crdt.json`](../../../tests/test-vectors/wal-crdt.json).
...
[`WalDocument`](03-document.md); you can use it directly to fold a log you obtained
some other way.
...
flag) — which is what a [snapshot](05-snapshots.md) carries in its `state` field.
...
**Ed25519 author verification** at the [document layer](03-document.md)
(~1–2 ms/element in pure JS). That is exactly what [snapshots](05-snapshots.md)
