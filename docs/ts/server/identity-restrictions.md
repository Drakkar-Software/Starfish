...
> **Prerequisites:** [Group & Shared-Collection Access](group-access.md)
...
- [Group & Shared-Collection Access](group-access.md) — grant access with member caps and enrichers
- [Root-Only Collections](root-only-collections.md) — restrict a collection to the root device
- [Config Endpoint](config-endpoint.md) — what clients can and cannot see
