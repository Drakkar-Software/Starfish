...
> **Prerequisites:** [Zustand Binding](05-state-zustand.md), [Offline & Connectivity](08-offline-connectivity.md)
...
- [Offline & Connectivity](08-offline-connectivity.md) — sync status and connectivity
- [Integration Patterns](09-integration-patterns.md) — restore-loop prevention (similar `isReceiving` guard)
