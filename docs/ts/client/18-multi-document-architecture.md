...
When to use one sync document versus many, how to design URL paths, and strategies for partitioning data across documents. This expands on the [Multiple Collections](09-integration-patterns.md#multiple-collections) section.

> **Prerequisites:** [SyncManager](03-sync-manager.md), [Integration Patterns](09-integration-patterns.md)
...
- **Tombstones** from [soft delete](09-integration-patterns.md#soft-delete--tombstone-pattern) accumulate over time — schedule cleanup
- **Local history** snapshots (if stored in the same document) can grow unboundedly

See [Compression](09-integration-patterns.md#compression) for reducing payload size.
...
For sync status across multiple stores, see [Offline & Connectivity — Multiple stores](08-offline-connectivity.md#multiple-stores).

## Next Steps

- [Integration Patterns](09-integration-patterns.md) — integration layer, compression, multiple collections
- [Data Export / Import](17-data-export-import.md) — exporting multiple documents
- [Schema Versioning](12-schema-versioning.md) — versioning per document
