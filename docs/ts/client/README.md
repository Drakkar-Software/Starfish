...
4. [Encryption](04-encryption.md) — E2E encryption design
...
10. [Identity & Key Derivation](11-identity-key-derivation.md) — auth and encryption key patterns
...
| [StarfishClient](02-starfish-client.md) | Low-level HTTP transport, auth providers, custom fetch |
| [SyncManager](03-sync-manager.md) | Encryption, conflict retry, signing, incremental sync |
| [Encryption](04-encryption.md) | Two-layer E2E encryption (HKDF + AES-256-GCM) |
...
| [Identity & Key Derivation](11-identity-key-derivation.md) | Auth patterns, password-based keys, key rotation |
