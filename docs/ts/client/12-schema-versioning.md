...
- [Integration Patterns](09-integration-patterns.md) — the backup document pattern that schema versioning builds on
- [Conflict Resolution](07-conflict-resolution.md) — version-aware merge strategies
